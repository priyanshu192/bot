...
console.log(chalk.bold.hex("#9900FF").bold(`[DATE & TIME IN AMERICA] » `)+ chalk.bold.hex("#9900FF").bold(DateAndTime));
...
console.log(chalk.bold.hex("#9900FF").bold("[ MrTomBot Don't Change] » Warning For Changes"));
...
☞ https://chat.whatsapp.com/Hog9Xpbgz9cK7EpfUKaHnC ☜
 ...
 ֎𝘊𝘰𝘯𝘵𝘢𝘤𝘵 𝘔𝘦 𝘖𝘯 𝘞𝘩𝘢𝘵𝘴𝘈𝘱𝘱֍ :- 
 ☞ +8801581712206 ☜`, "[ Sleep Mode ]")
...
console.log(chalk.bold.hex("#00FFFF").bold("================== SUBSCRIBE MRTOMXXX TO KNOW HOW TO DO THIS ====================="));
